...
let perguntaTecnologia = prompt("Tem mais alguma tecnologia que gostaria de aprender? Se sim, Digite 'ok'");

while(perguntaTecnologia === "ok"){
    let tecnologiaExtra = prompt("Qual o nome dela?");
    alert(`Muito interesante ${tecnologiaExtra}! Bastante promissora.`);
    perguntaTecnologia("Tem mais alguma tecnologia que gostaria de aprender? Se sim, Digite 'ok'");
}
