...
GO
PRINT N'Rename refactoring operation with key e7e7d1e3-25b7-4241-8b18-bd765d55c597 is skipped, element [dbo].[Dim_Categoria].[Id] (SqlSimpleColumn) will not be renamed to Cod_Categoria';


GO
PRINT N'Rename refactoring operation with key cb566710-6d9b-4b1a-bdd9-7a4214bb0b95 is skipped, element [dbo].[Dim_Marca].[Id] (SqlSimpleColumn) will not be renamed to Cod_Marca';


GO
PRINT N'Rename refactoring operation with key aff71557-adf4-4555-aff1-ca6dbd5fb4c8 is skipped, element [dbo].[Dim_Produto].[Id] (SqlSimpleColumn) will not be renamed to Cod_Produto';
