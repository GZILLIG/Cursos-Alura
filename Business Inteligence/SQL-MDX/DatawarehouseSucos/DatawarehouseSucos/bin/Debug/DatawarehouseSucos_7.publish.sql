...
GO
PRINT N'Rename refactoring operation with key 262a836d-dbe9-4b46-9e97-2901a1f00e6e is skipped, element [dbo].[Fato_001].[Id] (SqlSimpleColumn) will not be renamed to Cod_Cliente';


GO
PRINT N'Rename refactoring operation with key 4a12cc1b-d961-45c9-b24a-72fb8e0fb64c is skipped, element [dbo].[Fato_001].[Quantidade_vendida] (SqlSimpleColumn) will not be renamed to Quantidade_Vendida';
